                    ...
                    <c:forEach var="experience" items="${experiences}">
                        <div class="service-card" style="position: relative;">
                            <c:if test="${experience.promotionPercent > 0}">
                                <div class="promotion-badge">${experience.promotionPercent}%</div>
                            </c:if>
                            <div class="d-flex">
                                ...
                                <div class="service-content">
                                    ...
                                    <div class="d-flex justify-content-between align-items-end">
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <a href="#" class="btn-action btn-promotion" data-bs-toggle="modal" data-bs-target="#promotionModal"
                                               data-service-id="${experience.experienceId}" data-service-type="experience">
...
<form method="POST" action="${pageContext.request.contextPath}/host/toggle-service" style="display: inline;">
                    ...
                    <c:forEach var="accommodation" items="${accommodations}">
                        <div class="service-card" style="position: relative;">
                            <c:if test="${accommodation.promotionPercent > 0}">
                                <div class="promotion-badge">${accommodation.promotionPercent}%</div>
                            </c:if>
                            <div class="d-flex">
                                <div class="flex-shrink-0">
                                    <c:choose>
                                ...
                                <div class="service-content">
                                    ...
                                    <div class="d-flex justify-content-between align-items-end">
                                        ...
                                        <div class="action-buttons">
                                            ...
                                            <a href="#" class="btn-action btn-promotion" data-bs-toggle="modal" data-bs-target="#promotionModal"
                                               data-service-id="${accommodation.accommodationId}" data-service-type="accommodation">
                                                <i class="ri-gift-line"></i> Khuyến mãi
                                            </a>
    ...
    <div class="modal fade" id="promotionModal" tabindex="-1" aria-labelledby="promotionModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form id="promotionForm" method="POST" action="${pageContext.request.contextPath}/host/services/promotion">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="promotionModalLabel"><i class="ri-gift-line me-2"></i>Thiết lập khuyến mãi</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <input type="hidden" name="serviceId" id="promotionServiceId">
                        <input type="hidden" name="serviceType" id="promotionServiceType">
                        <div class="mb-3">
                            <label for="promotionPercent" class="form-label">Phần trăm khuyến mãi (%)</label>
                            <input type="number" class="form-control" id="promotionPercent" name="promotionPercent" min="1" max="100" required>
                        </div>
                        <div class="mb-3">
                            <label for="promotionStart" class="form-label">Ngày bắt đầu</label>
                            <input type="datetime-local" class="form-control" id="promotionStart" name="promotionStart" required>
                        </div>
                        <div class="mb-3">
                            <label for="promotionEnd" class="form-label">Ngày kết thúc</label>
                            <input type="datetime-local" class="form-control" id="promotionEnd" name="promotionEnd" required>
                        </div>
                    </div>
    ...
    <script>
        ...
        promotionModal.addEventListener('show.bs.modal', function(event) {
            ...
            document.getElementById('promotionServiceId').value = serviceId;
            document.getElementById('promotionServiceType').value = serviceType;
        });
    </script>
