                                    ...
                                    <c:choose>
                                        <c:when test="${favorite.type == 'experience' && not empty favorite.experience}">
                                            ...
                                            <div class="card-footer">
                                                <div class="price-row" style="display: flex; align-items: center; flex-direction: column; gap: 8px;">
                                                    <c:set var="isPromo" value="${favorite.experience.promotionPercent > 0 
                                                        && favorite.experience.promotionStart != null 
                                                        && favorite.experience.promotionEnd != null 
                                                        && now.time >= favorite.experience.promotionStart.time 
                                                        && now.time <= favorite.experience.promotionEnd.time}" />
                                                        ...
                                                        <c:choose>
                                                            ...
                                                            <c:when test="${isPromo}">
                                                                ...
                                                                <span style="color: #ff385c; font-weight: bold;">
                                                                    <fmt:formatNumber value="${favorite.experience.price * (1 - favorite.experience.promotionPercent / 100.0)}" type="currency" currencySymbol="" maxFractionDigits="0" /> VNĐ
                                                                </span>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <fmt:formatNumber value="${favorite.experience.price}" type="currency" currencySymbol="" maxFractionDigits="0" /> VNĐ
                                                    ...
                                                    <c:if test="${favorite.experience.price > 0 && isPromo}">
                                                        <div style="background: linear-gradient(45deg, #ff6b35, #ff385c); color: white; padding: 4px 8px; border-radius: 12px; font-size: 0.7rem; font-weight: 600; text-transform: uppercase;">
                                                            Khuyến mãi ${favorite.experience.promotionPercent}%
                                                        </div>
                                                    </c:if>
                                                </div>
                                        ...
                                        <c:when test="${favorite.type == 'accommodation' && not empty favorite.accommodation}">
                                            ...
                                            <div class="card-footer">
                                                <div class="price-row" style="display: flex; align-items: center; flex-direction: column; gap: 8px;">
                                                    <c:set var="isPromo" value="${favorite.accommodation.promotionPercent > 0 
                                                        && favorite.accommodation.promotionStart != null 
                                                        && favorite.accommodation.promotionEnd != null 
                                                        && now.time >= favorite.accommodation.promotionStart.time 
                                                        && now.time <= favorite.accommodation.promotionEnd.time}" />
                                                    <div class="price" style="display: flex; align-items: center; gap: 8px;">
                                                        <c:choose>
                                                            <c:when test="${isPromo}">
                                                                <span style="text-decoration: line-through; color: #888; font-size: 0.9em;">
                                                                ...
                                                                <span style="color: #ff385c; font-weight: bold;">
                                                                    <fmt:formatNumber value="${favorite.accommodation.pricePerNight * (1 - favorite.accommodation.promotionPercent / 100.0)}" type="currency" currencySymbol="" maxFractionDigits="0" /> VNĐ/đêm
                                                                </span>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <fmt:formatNumber value="${favorite.accommodation.pricePerNight}" type="currency" currencySymbol="" maxFractionDigits="0" /> VNĐ/đêm
                                                    ...
                                                    <c:if test="${isPromo}">
                                                        <div style="background: linear-gradient(45deg, #ff6b35, #ff385c); color: white; padding: 4px 8px; border-radius: 12px; font-size: 0.7rem; font-weight: 600; text-transform: uppercase;">
                                                            Khuyến mãi ${favorite.accommodation.promotionPercent}%
                                                        </div>
                                                    </c:if>
                                                </div>
