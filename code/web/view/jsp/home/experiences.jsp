                            ...
                            <div class="card-item">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="card-footer">
                                        <div class="price-row" style="display: flex; align-items: center;">
                                            <div class="price">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:when test="${isPromo}">
                                                        <span style="text-decoration: line-through; color: #888; font-size: 0.95em;">
                                                            <fmt:formatNumber value="${experience.price}" type="currency" currencySymbol="" maxFractionDigits="0" /> VNĐ
                                                        </span>
                                                        <span style="color: #ff385c; font-weight: bold; margin-left: 8px;">
