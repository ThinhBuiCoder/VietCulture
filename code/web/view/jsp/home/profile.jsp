            ...
            <div class="nav-right">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <%-- Common profile options - ACTIVE STATE --%>
                        <li>
                            <a class="dropdown-item active" href="${pageContext.request.contextPath}/profile" style="color: white; background-color: #10466C; font-weight: 700;">
    ...
    <div class="profile-container">
        ...
        <div class="profile-content">
            ...
            <div class="profile-sidebar">
                ...
                <div class="profile-card">
                    <h4><i class="ri-calendar-check-line"></i>Lịch Sử Đặt Chỗ</h4>
                    <div class="d-grid">
                        <a href="${pageContext.request.contextPath}/booking/history" class="btn btn-outline-primary">
                            <i class="ri-history-line me-2"></i>Xem Lịch Sử Đặt Chỗ
                        </a>
                    </div>
                    <div class="mt-3">
                        <div class="info-item">
                            ...
                            <div class="info-content">
                                <div class="info-label">Tổng số đặt chỗ</div>
                                <div class="info-value">${totalBookings}</div>
                            </div>
                        </div>
                    </div>
                </div>
