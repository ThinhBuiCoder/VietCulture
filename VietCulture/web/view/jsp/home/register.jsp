    ...
    <style>
        ...
        * {
        ...
        .is-valid {
            ...
            background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 8 8'%3e%3cpath fill='%2328a745' d='m2.3 6.73.02-.02L7 1.47l.15-.15-.12-.14L6.88 1.15.12-.02 1.17 0 1.02.15 6.17l-.15.15-4.55 4.54L1 6.5l.02.03.01.02.05.02z'/%3e%3c/svg%3e");
        }

        .is-invalid {
            border-color: var(--danger-color) !important;
            background-image: url("data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 12 12' width='12' height='12' fill='none' stroke='%23dc3545'%3e%3ccircle cx='6' cy='6' r='4.5'/%3e%3cpath d='m5.8 4.6.25-.25a1 1 0 011.42 1.42L6.6 6.6l.87.87a1 1 0 01-1.42 1.42L5.18 8l-.87.87a1 1 0 01-1.42-1.42l.87-.87-.87-.87a1 1 0 011.42-1.42l.87.87z'/%3e%3c/svg%3e");
        }
...
<body>
    <div class="register-container">
        <div class="register-header">
            ...
            <p>Tham gia cộng đồng du lịch VietCulture ngay hôm nay!</p>
        </div>
        ...
        <div class="register-body">
            ...
            <c:if test="${not empty successMessage}">
                <div class="success-message">
                    ...
                    <c:if test="${not empty registeredEmail}">
                        <p>Email: <strong>${registeredEmail}</strong></p>
            ...
            <c:if test="${empty successMessage}">
                <form action="${pageContext.request.contextPath}/register" method="post" 
                      id="registerForm" novalidate class="position-relative">
                    ...
                    <div class="loading-overlay d-none" id="loadingOverlay">
                        <div class="text-center">
                            ...
                            <p class="mb-0">Đang tạo tài khoản...</p>
                        </div>
                    </div>
                    ...
                    <div class="role-selector">
                        <label class="form-label fw-semibold fs-5">
                            <i class="fas fa-user-tag me-2"></i>Bạn muốn tham gia với vai trò: *
                        </label>
                        <div class="row g-3">
                            <div class="col-md-6">
                        ...
                        <div class="text-danger d-none mt-2" id="roleError">
                            ...
                            Vui lòng chọn vai trò tham gia
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="newsletter">
                                ...
                                Nhận thông tin khuyến mãi và cập nhật mới từ VietCulture
                            </label>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Preserve selected role after form submission
            ...
            // Password strength checker with enhanced logic
            ...
            validateInput(document.getElementById('fullName'), function(value) {
                const nameRegex = /^[a-zA-ZÀ-ỹ\s]+$/;
                return value.length >= 2 && value.length <= 100 && nameRegex.test(value);
            });
            
            // Email validation
            validateInput(document.getElementById('email'), function(value) {
            ...
            document.addEventListener('keydown', function(e) {
                ...
                if (e.key === 'Escape' && e.shiftKey) {
                    if (confirm('Bạn có muốn xóa toàn bộ thông tin đã nhập?')) {
                        ...
                        passwordHint.className = 'text-muted mt-1';
                    }
                }
            });
            
            // Auto-save form data to sessionStorage (except passwords)
            ...
            emailInput.addEventListener('blur', function() {
                ...
                if (email && email.includes('@')) {
                    ...
                    if (suggestions.length > 0 && domain.length > 2) {
                        const suggestion = suggestions[0];
                        if (confirm(`Bạn có muốn sửa thành "${localPart}@${suggestion}"?`)) {
                            this.value = `${localPart}@${suggestion}`;
            ...
            // Reset loading state if page reloads with errors
