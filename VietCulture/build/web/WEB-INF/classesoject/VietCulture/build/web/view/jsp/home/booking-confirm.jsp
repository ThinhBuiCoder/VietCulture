            ...
            <div>
                ...
                <form id="confirmForm" action="${pageContext.request.contextPath}/booking" method="post">
                    ...
                    <div class="action-buttons">
                        ...
                        <button type="submit" class="btn btn-success" id="cashPaymentBtn" onclick="setFormAction('confirm')">
                            <span class="btn-text">
                        ...
                        <button type="submit" class="btn btn-primary" id="onlinePaymentBtn" onclick="setFormAction('payment')">
                            <span class="btn-text">
