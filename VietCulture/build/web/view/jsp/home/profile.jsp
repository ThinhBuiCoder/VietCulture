            ...
            <div class="profile-header">
                <div class="d-flex align-items-center">
                    ...
                    <div class="profile-info flex-grow-1">
                        ...
                        <p class="mb-2">
                            <i class="ri-mail-line me-2"></i>${profileUser.email}
                        </p>
                        <div class="d-flex align-items-center gap-3">
                            <span class="badge badge-primary">${profileUser.role}</span>
                            <c:choose>
                        ...
                        <div class="profile-stats">
                            ...
                            <c:if test="${profileUser.role == 'HOST'}">
                                <div class="stat-item">
                            ...
                            <div class="stat-item">
                                <span class="stat-number">
                                    <fmt:formatDate value="${profileUser.createdAt}" pattern="yyyy"/>
                                </span>
                ...
                <div class="profile-sidebar">
                    ...
                    <div class="profile-card">
                        ...
                        <div class="info-item">
                            ...
                            <span class="value">${profileUser.phone != null ? profileUser.phone : 'Chưa cập nhật'}</span>
                        </div>
                        <div class="info-item">
                            <span class="label">Ngày sinh:</span>
                            <span class="value">
                                <c:choose>
                                    <c:when test="${profileUser.dateOfBirth != null}">
                        ...
                        <div class="info-item">
                            ...
                            <span class="value">${profileUser.gender != null ? profileUser.gender : 'Chưa cập nhật'}</span>
                        </div>
                        <div class="info-item">
                        ...
                        <c:if test="${not empty profileUser.bio}">
                            <div class="info-item">
                                ...
                                <span class="value">${profileUser.bio}</span>
                            </div>
                        </c:if>
                    </div>
                    ...
                    <!-- Statistics Card -->
                    <div class="profile-card">
                        <h4><i class="ri-bar-chart-line"></i>Thống Kê</h4>
                    ...
                    <ul class="nav nav-tabs" id="profileTabs" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="history-tab" data-bs-toggle="tab" data-bs-target="#history-pane" type="button" role="tab">
                                <i class="ri-bookmark-line me-2"></i>Lịch Sử Đặt Chỗ
                            </button>
                        </li>
                    </ul>
                                ...
                                <form action="${pageContext.request.contextPath}/profile/update" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="bio" name="bio" rows="4" 
                                                  placeholder="Viết vài dòng giới thiệu về bản thân...">${profileUser.bio}</textarea>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="history-pane" role="tabpanel">
                            <div class="profile-card">
                                <h5 class="mb-4 text-primary">
                                    <i class="ri-bookmark-line me-2"></i>Lịch Sử Đặt Chỗ Gần Đây
                                </h5>
                                <div class="d-flex justify-content-end mb-2">
                                    <a href="${pageContext.request.contextPath}/profile/bookings?userId=${profileUser.userId}" class="btn btn-outline-primary btn-sm">
                                        <i class="ri-list-unordered me-1"></i> Xem tất cả lịch sử đặt chỗ
                                    </a>
                                </div>
                                <c:choose>
