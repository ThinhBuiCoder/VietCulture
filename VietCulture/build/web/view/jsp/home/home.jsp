            ...
            ${sessionScope.user.fullName}
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <c:if test="${sessionScope.user.role == 'HOST'}">
                                    <li>
                                        <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#createChoiceModal" style="color: #10466C; font-weight: 600;">
                                            <i class="ri-add-circle-line"></i> Tạo Mới
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="${pageContext.request.contextPath}/edit_experience" style="color: #10466C; font-weight: 600;">
                        ...
                        <div class="col-6">
                            <a href="${pageContext.request.contextPath}/Travel/create_accommodation" class="text-decoration-none">
                                <div class="card h-100 text-center p-3 hover-shadow">
                                    ...
                                    <p class="card-text small text-muted">Tạo một địa điểm lưu trú hấp dẫn</p>
                                </div>
                            </a>
                        </div>
                    </div>
