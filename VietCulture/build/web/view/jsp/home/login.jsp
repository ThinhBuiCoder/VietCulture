...
<body>
    <div class="container">
        <div class="login-card">
            ...
            <form action="${pageContext.request.contextPath}/login" method="POST" id="loginForm">
                ...
                <div class="form-group position-relative">
                    <input type="password" class="form-control" name="password" placeholder="Mật khẩu" required id="passwordInput" minlength="8">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="${pageContext.request.contextPath}/forgot-password" class="text-decoration-none" style="color: #667eea; font-size: 14px;">Quên mật khẩu?</a>
                </div>
    ...
    <script>
        ...
        // Log for debugging
        console.log('Login page loaded - Redirect method only');
