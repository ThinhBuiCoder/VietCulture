...
<head>
    ...
    <title>Tạo Lưu Trú Mới - VietCulture</title>
    ...
    <style>
        ...
        * {
        ...
        /* Sửa lỗi không click được vào input file */
        .file-input {
...
<body>
    ...
    <div class="custom-navbar">
        <div class="container">
            ...
            <div class="nav-center">
                ...
                <a class="nav-center-item" href="${pageContext.request.contextPath}/Travel/Travel">
                    Trải Nghiệm
                </a>
                <a class="nav-center-item active" href="${pageContext.request.contextPath}/save">
                    Lưu Trú
                </a>
            </div>
            <div class="nav-right">
    ...
    <div class="page-container">
        <div class="page-header">
            <h1 class="page-title">Tạo Lưu Trú Mới</h1>
            <p class="page-subtitle">Chia sẻ không gian của bạn với du khách từ khắp nơi</p>
        </div>

        <!-- Thêm thanh điều hướng phụ -->
        <div class="sub-nav">
            <a href="${pageContext.request.contextPath}/Travel/create_experience" class="sub-nav-btn">
                <i class="ri-compass-3-line"></i> Tạo Trải Nghiệm
            </a>
            <a href="${pageContext.request.contextPath}/Travel/create_accommodation" class="sub-nav-btn active">
        ...
        <form action="${pageContext.request.contextPath}/Travel/create_accommodation" method="post" enctype="multipart/form-data">
            <div class="form-container">
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="name" class="form-label">Tên lưu trú</label>
                            <input type="text" class="form-control" id="name" name="name" required placeholder="Nhập tên lưu trú" maxlength="100">
                        </div>
                        <div class="form-group">
                            <label for="type" class="form-label">Loại lưu trú</label>
                            <select class="form-select" id="type" name="type" required>
                                <option value="">Chọn loại lưu trú</option>
                                <option value="Homestay">Homestay</option>
                                <option value="Hotel">Khách sạn</option>
                                <option value="Resort">Khu nghỉ dưỡng</option>
                                <option value="Guesthouse">Nhà trọ</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="description" class="form-label">Mô tả</label>
                        <textarea class="form-control form-textarea" id="description" name="description" rows="4" placeholder="Nhập mô tả chi tiết"></textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="address" name="address" required placeholder="Nhập địa chỉ chi tiết">
                        </div>
                        <div class="form-group">
                ...
                <div class="form-section">
                    <div class="section-header">
                        ...
                        <h2 class="section-title">Chi tiết lưu trú</h2>
                    </div>
                    <div class="form-grid">
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-textarea" id="amenities" name="amenities" rows="3" placeholder="Liệt kê các tiện nghi (mỗi tiện nghi một dòng)"></textarea>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        <label for="image" class="form-label">Tải lên hình ảnh (tối đa 5 hình)</label>
                        <div class="image-upload-container" id="imageUploadContainer" style="position: relative;">
                            <input type="file" class="file-input" id="image" name="image" accept="image/*" multiple required>
                        ...
                        <div id="accommodationImagePreview" class="image-preview-container"></div>
                    </div>
                </div>

                <!-- Nút gửi -->
                <div class="form-actions">
                    <button type="submit" class="btn-submit">Tạo Lưu Trú</button>
                </div>
            </div>
        </form>
    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('#image').on('change', function(event) {
                const previewContainer = $('#accommodationImagePreview');
